...
std::unique_ptr<ur_driver::URwInspireHardwareInterface> g_hw_interface;
...
{
  // Set up ROS.
  ros::init(argc, argv, "ur_with_inspire_hardware_interface");
  ...
  g_hw_interface.reset(new ur_driver::URwInspireHardwareInterface);
