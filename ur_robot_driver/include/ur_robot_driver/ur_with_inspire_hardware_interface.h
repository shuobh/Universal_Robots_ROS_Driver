 ...
 * topics and services.
 */
class URwInspireHardwareInterface : public hardware_interface::RobotHW
{
public:
  /*!
...
protected:
  ...
  static void handCommunicationThread(inspire_hand::hand_serial& inspire_hand, bool& in_freedrive, bool& power_open, bool& power_close);
