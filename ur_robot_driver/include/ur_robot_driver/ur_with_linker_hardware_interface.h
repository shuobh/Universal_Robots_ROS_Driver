 ...
 * topics and services.
 */
class URwLinkerHardwareInterface : public hardware_interface::RobotHW
{
public:
  /*!
   * \brief Creates a new HardwareInterface object.
   */
  URwLinkerHardwareInterface();
  virtual ~URwLinkerHardwareInterface() {hand_control_thread_.join();};
  /*!
...
protected:
  ...
  static void handCommunicationThread(linker_hand::hand_comm& linker_hand, bool& in_freedrive, bool& power_open, bool& power_close);
  ...
  linker_hand::hand_comm linker_hand_;
